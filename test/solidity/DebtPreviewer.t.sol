...
contract DebtPreviewerTest is ForkTest {
  ...
  function testPreviewLeverageNegativePrincipal() external {
    ...
    Limit memory limit = debtPreviewer.previewWithdraw(marketwstETH, marketWETH, address(this), 1e18);
    assertEq(leverage.ratio, 1e18);
    assertEq(leverage.deposit, 0);
    ...
    limit = debtPreviewer.previewDeposit(marketwstETH, marketWETH, address(this), 0.5e18);
    assertEq(limit.principal, 0.5e18 - 885726732210286685);
    assertEq(limit.maxRatio, 3048780487804878048);
    limit = debtPreviewer.previewDeposit(marketwstETH, marketWETH, address(this), 1e18);
  ...
  function testPreviewCrossLeverageWithUSDCDeposit() external {
    ...
    Limit memory limit = debtPreviewer.previewDeposit(marketUSDC, marketWETH, address(this), newDeposit);
  ...
  function testPreviewCrossLeverageWithWETHDeposit() external {
    ...
    Limit memory limit = debtPreviewer.previewDeposit(marketWETH, marketUSDC, address(this), newDeposit);
  ...
  function testPreviewLeverageSameUSDCAssetWithDeposit() external {
    ...
    Limit memory limit = debtPreviewer.previewDeposit(marketUSDC, marketUSDC, address(this), newDeposit);
  ...
  function testPreviewMaxRatioWithdraw() external {
    ...
    Limit memory limit = debtPreviewer.previewWithdraw(marketUSDC, marketWETH, address(this), withdrawAssets);
  ...
  function testPreviewMultipleMaxRatioWithdraw() external {
    ...
    assertApproxEqAbs(
      debtPreviewer.previewWithdraw(marketUSDC, marketWETH, address(this), 1_000e6).maxRatio,
      3.1e18,
      0.02e18
    );
    assertApproxEqAbs(
      debtPreviewer.previewWithdraw(marketUSDC, marketWETH, address(this), 2_000e6).maxRatio,
      2.97e18,
      0.02e18
    );
    assertApproxEqAbs(
      debtPreviewer.previewWithdraw(marketUSDC, marketWETH, address(this), 3_000e6).maxRatio,
      2.78e18,
      0.02e18
    );
    assertApproxEqAbs(
      debtPreviewer.previewWithdraw(marketUSDC, marketWETH, address(this), 4_000e6).maxRatio,
      2.54e18,
      0.02e18
    );
    Limit memory limit = debtPreviewer.previewWithdraw(marketUSDC, marketWETH, address(this), 5_000e6);
  ...
  function testPreviewMaxRatioWithdrawWithSameAssetLeverage() external {
    ...
    assertApproxEqAbs(
      debtPreviewer.previewWithdraw(marketUSDC, marketUSDC, address(this), 10_000e6).maxRatio,
      5.81e18,
      0.008e18
    );
    assertApproxEqAbs(
      debtPreviewer.previewWithdraw(marketUSDC, marketUSDC, address(this), 40_000e6).maxRatio,
      5.81e18,
      0.008e18
    );
  }
