...
contract Market is Initializable, AccessControlUpgradeable, PausableUpgradeable, ERC4626 {
  ...
  /// @notice Checks if the account can borrow at a certain fixed pool and returns the modified duration metric that
  /// captures the average term of outstanding fixed rate debt.
  /// @param maturity maturity date of the fixed pool.
