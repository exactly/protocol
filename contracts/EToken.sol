...
contract EToken is Context, IERC20, IERC20Metadata {
    ...
    **/
    function balanceOf(address account) public view virtual override returns (uint256) {
        return balances[account] + balances[account] * (liquidityReserveIndex - earningsIndexUser[account]) / 1e18;
    }
    ...
    */
    function mint(
        ...
        balances[user] += (balances[user] * (liquidityReserveIndex - earningsIndexUser[user]) / 1e18) + amount;
    ...
    **/
    function burn(address user, uint256 amount) public virtual {
        ...
        balances[user] -= amount - (balances[user] * (liquidityReserveIndex - earningsIndexUser[user]) / 1e18);
        liquidityReserveIndex -= amount / _totalSupply * 1e18;
        earningsIndexUser[user] = liquidityReserveIndex;
        _totalSupply -= amount;
