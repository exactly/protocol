...
contract VerifiedAuditor is Auditor {
  ...
  constructor(uint256 _priceDecimals, Firewall _firewall) Auditor(_priceDecimals) {
  ...
  function setFirewall(Firewall _firewall) public onlyRole(DEFAULT_ADMIN_ROLE) {
    _setFirewall(_firewall);
  }
