...
1. EToken has Auditor address as state variable and directly calls beforeTransferSmartPool() function.
...
2. Since EToken already has the FixedLender's address, it calls a FixedLender's function and that function finally calls beforeTransferSmartPool() from Auditor contract.
